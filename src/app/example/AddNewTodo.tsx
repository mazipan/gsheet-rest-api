...
export function AddNewTodo() {
  // @ts-ignore
  const [_, formAction, pending] = useActionState(addNewTodo, false)
  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="cursor-pointer rounded-lg bg-blue-700 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        + Add new item
      </button>
      {showForm && (
